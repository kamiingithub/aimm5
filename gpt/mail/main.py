...
# 设置页面标题
st.set_page_config(page_title="邮件礼宾助手", page_icon="✉️", layout="wide")
st.title("✒️邮件礼宾助手📧")
...
def chatgpt_response(user_message):
    messages = [
        HumanMessage(content="请根据:::后的文字生成一段正式的中文邮件内容，仅返回转换后的对话:::" + user_message)
...
# Accept user input
if user_message := st.chat_input("input what you want to email…"):
